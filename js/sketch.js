...
if (pointing && object_results && object_results.detections) {
    ...
    for (let detection of object_results.detections) {
        ...
        if (
            ...
            const allowedNames = [
                'mugi', 'ryokucha', 'water', 'latte', 'black', 'Coldore',
                'Coldsugar', 'Coldblack', 'cola', 'realgoldPet', 'aquarius',
                'milktea', 'sugar2', 'black2', 'milkore', 'ryokuchaMini',
                'apple', 'realgold', 'sprite', 'yuzu', 'conepotage',
                'Hotore', 'Hotsugar', 'Hotblack'
            ];
...
if (allowedNames.includes(name)) {
            ...
            else if (name === 'conepotage') {
                if (detectedGestureName === 'Pointing_Up') {
                    textToSpeak = 'フード';
                } else if (detectedGestureName === 'Victory') {
                    textToSpeak = 'コーンポタージュ';
                } else if (detectedGestureName === 'THREE') {
                    textToSpeak = 'ホット';
                } else if (detectedGestureName === 'FOUR') {
                    textToSpeak = '缶';
